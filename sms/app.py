...
DOWNLOAD_DIRECTORY = '/Users/austinarrington/soc-app/sms/img'
META_DIRECTORY = '/Users/austinarrington/soc-app/sms/img/metadata'
# darksky
...
def sms_reply():
    ...
    if request.values['NumMedia'] != '0':
        ...
        # SMS txt metadata
        with open('/Users/austinarrington/soc-app/sms/img/metadata/'+textFile, 'a') as output:
            output.write(request.values['Body'])
        
        # save light context data
        try:
            with open('/Users/austinarrington/soc-app/sms/img/light_data/'+textFile, 'a') as output:
    ...
    img = cv2.imread('/Users/austinarrington/soc-app/sms/img/'+str(target_file))
